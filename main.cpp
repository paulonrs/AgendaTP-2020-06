...
void editarCompromisso() {
	...
	//variasveis usadas para montar o query
	std::string dia, mes, ano, descricao;
	
	//Mostrar os compromissos
	verCompromissos();

	// Dia do compromisso que sera alterado
	std::cout << "Informe o dia do compromisso que voce deseja alterar: ";
	std::cin >> dia;
	
	// mes do compromisso que sera alterado
	std::cout << "Informe o mês do compromisso que voce deseja alterar: ";
	std::cin >> mes;
	
	// ano do compromisso que sera alterado
	std::cout << "Informe o ano do compromisso que voce deseja alterar: ";
	std::cin >> ano;
	...
	//Adicionar o compromisso novamente
	void adicionarCompromisso();
